...
Either specify options.terrainProvider instead or set options.baseLayerPicker to true."
  ...
  viewerContainer.className = "mcsmap-viewer";
  container.appendChild(viewerContainer);

  // Cesium widget container
  var cesiumWidgetContainer = document.createElement("div");
  cesiumWidgetContainer.className = "mcsmap-viewer-mcsmapWidgetContainer";
  viewerContainer.appendChild(cesiumWidgetContainer);

  // Bottom container
  var bottomContainer = document.createElement("div");
  bottomContainer.className = "mcsmap-viewer-bottom";
  ...
  // Cesium widget
  var mcsmapWidget = new CesiumWidget(cesiumWidgetContainer, {
    imageryProvider:
  ...
  if (
    ...
    selectionIndicatorContainer.className =
      "mcsmap-viewer-selectionIndicatorContainer";
  ...
  if (!defined(options.infoBox) || options.infoBox !== false) {
    ...
    infoBoxContainer.className = "mcsmap-viewer-infoBoxContainer";
  ...
  toolbar.className = "mcsmap-viewer-toolbar";
  ...
  if (!defined(options.geocoder) || options.geocoder !== false) {
    ...
    geocoderContainer.className = "mcsmap-viewer-geocoderContainer";
  ...
  if (!defined(options.animation) || options.animation !== false) {
    ...
    animationContainer.className = "mcsmap-viewer-animationContainer";
  ...
  if (!defined(options.timeline) || options.timeline !== false) {
    ...
    timelineContainer.className = "mcsmap-viewer-timelineContainer";
  ...
  if (
    ...
    fullscreenContainer.className = "mcsmap-viewer-fullscreenContainer";
  ...
  if (options.vrButton) {
    ...
    vrContainer.className = "mcsmap-viewer-vrContainer";
  ...
  this._mcsmapWidget = mcsmapWidget;
  ...
  mcsmapWidget.screenSpaceEventHandler.setInputAction(
    pickAndSelectObject,
...
Object.defineProperties(Viewer.prototype, {
  ...
  canvas: {
    get: function () {
      return this._mcsmapWidget.canvas;
    },
  },
  ...
  scene: {
    get: function () {
      return this._mcsmapWidget.scene;
    },
  },
  ...
  screenSpaceEventHandler: {
    get: function () {
      return this._mcsmapWidget.screenSpaceEventHandler;
    },
  },
  ...
  targetFrameRate: {
    get: function () {
      return this._mcsmapWidget.targetFrameRate;
    },
    set: function (value) {
      this._mcsmapWidget.targetFrameRate = value;
    },
  },
  ...
  useDefaultRenderLoop: {
    get: function () {
      return this._mcsmapWidget.useDefaultRenderLoop;
    },
    set: function (value) {
      this._mcsmapWidgett.useDefaultRenderLoop = value;
    },
  },
  ...
  resolutionScale: {
    get: function () {
      return this._mcsmapWidget.resolutionScale;
    },
    set: function (value) {
      this._mcsmapWidget.resolutionScale = value;
    },
  },
  ...
  useBrowserRecommendedResolution: {
    get: function () {
      return this._mcsmapWidget.useBrowserRecommendedResolution;
    },
    set: function (value) {
      this._mcsmapWidget.useBrowserRecommendedResolution = value;
    },
  },
...
Viewer.prototype.resize = function () {
  var mcsmapWidget = this._mcsmapWidget;
...
Viewer.prototype.destroy = function () {
  ...
  this._mcsmapWidget = this._mcsmapWidget.destroy();

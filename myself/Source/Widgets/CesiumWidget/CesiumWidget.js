...
function CesiumWidget(container, options) {
  ...
  element.className = "mcsmap-widget";
  ...
  innerCreditContainer.className = "mcsmap-widget-credits";
...
CesiumWidget.prototype.showErrorPanel = function (title, message, error) {
  ...
  overlay.className = "mcsmap-widget-errorPanel";

  var content = document.createElement("div");
  content.className = "mcsmap-widget-errorPanel-content";
  overlay.appendChild(content);

  var errorHeader = document.createElement("div");
  errorHeader.className = "mcsmap-widget-errorPanel-header";
  errorHeader.appendChild(document.createTextNode(title));
  content.appendChild(errorHeader);

  var errorPanelScroller = document.createElement("div");
  errorPanelScroller.className = "mcsmap-widget-errorPanel-scroll";
  ...
  if (hasMessage || hasError) {
    ...
    errorMessage.className = "mcsmap-widget-errorPanel-message";
    ...
    if (hasError) {
      ...
      errorMessageDetails.className =
        "mcsmap-widget-errorPanel-message-details collapsed";

      var moreDetails = document.createElement("span");
      moreDetails.className = "mcsmap-widget-errorPanel-more-details";
      ...
      errorMessageDetails.onclick = function (e) {
        ...
        errorMessageDetails.className =
          "mcsmap-widget-errorPanel-message-details";
        content.className = "mcsmap-widget-errorPanel-content expanded";
  ...
  buttonPanel.className = "mcsmap-widget-errorPanel-buttonPanel";
  content.appendChild(buttonPanel);

  var okButton = document.createElement("button");
  okButton.setAttribute("type", "button");
  okButton.className = "mcsmap-button";
